...
# --- Session Recall After Analysis ---
st.subheader("🗂️ Save & Recall Sessions")
...
if "organization" in st.session_state:
    ...
    - **Exposure Type**: {st.session_state['exposure_type']}
    - **Limit**: {st.session_state['limit']} ppm
    """)

    # Option to rename and save again
    new_name = st.text_input("Save this session as:", value=datetime.now().strftime("%Y-%m-%d %H:%M:%S"))
    if st.button("💾 Save Session"):
        ...
        st.success(f"Session saved as '{new_name}'")
